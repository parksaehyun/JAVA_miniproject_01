...
public class Client {
    ...
    public Client(String name, Consumer<org.choongang.global.socket.SocketData> handler) {
        this.name = name;
        om = new ObjectMapper();
        ...
        Thread inputTh = new Thread(() -> {
            try (DataInputStream dis = new DataInputStream(socket.getInputStream())) {
                ...
                while(true) {
                    ...
                    org.choongang.global.socket.SocketData data = om.readValue(json, org.choongang.global.socket.SocketData.class);
                    handler.accept(data);
                }
    ...
    public void send(org.choongang.global.socket.SocketData data) {
